...
| 阶段 | 名称 | 目标 | 预计周期 |
|------|------|------|----------|
| **Phase 1** | 核心框架 | Tauri 骨架 + 账户管理 + 存储 | 1-2 周 |
| **Phase 2** | 浏览器与画布 | 浏览器自动化 + 登录 + 画布同步 | 2-3 周 |
| **Phase 3** | 脚本执行 | 场景匹配 + 脚本引擎 + OCR | 2 周 |
| **Phase 4** | 扩展功能 | 键盘透传 + 批量操作 + 优化 | 1-2 周 |
...
| rdev 权限问题 (macOS) | 键盘监听 | 提供权限引导，降级方案 |
